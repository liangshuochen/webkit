...
WTF::String Matrix::toString() {
    return "(a=" + WTF::String::number(this->a) + ", b=" + WTF::String::number(this->b) + ", c=" + WTF::String::number(this->c) +
    ", d=" + WTF::String::number(this->d) + ", tx=" + WTF::String::number(this->tx) + ", ty=" + WTF::String::number(this->ty) +
           ")";
}
