...
var rect = new Rectangle0(0, 0, 0, 0);
var matrix = new Matrix0(2, 0, 0, 0.5, 11, 19);
...
var jsTime = Date.now() - start;
print("JS-NoField--Time:" + jsTime + "ms");
...
print("JSBinding--Time:" + jsBindingTime + "ms");
...
for (t = 0; t < TIMES; t++) {
    ...
    for (i = 0; i < SIZE; i++) {
        ...
        width = data[index++];
        height = data[index++];
        rect.setToAsTypedArray(data);
        matrix.transformBounds(rect);
    }
}
jsBindingTime = Date.now() - start;
print("JSBinding2--Time:" + jsBindingTime + "ms");
